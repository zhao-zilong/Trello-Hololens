...
namespace TMPro.Examples
{
    ...
    public class TMP_TextSelector_A : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        void LateUpdate()
        {
            ...
            if (TMP_TextUtilities.IsIntersectingRectTransform(m_TextMeshPro.rectTransform, pos, Camera.main))
            {
            ...
            if (m_isHoveringObject)
            {
                ...
                #endregion
                //int link = TMP_TextUtilities.FindIntersectingLink(m_TextMeshPro, pos, Camera.main);
                //if (link != -1)
                //{
                //    TMP_LinkInfo linkInfo = this.gameObject.GetComponent<TMP_InputField>().textComponent.textInfo.linkInfo[linkIndex];
                //    UIVertex[] uiVertices = m_TextMeshPro.textInfo.meshInfo.u;
                //}
                //m_TextMeshPro.canvasRenderer.SetVertices()
